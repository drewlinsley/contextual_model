...
from ops.daemon_f7_hp_optim import optimize_model, create_stimuli, adjust_parameters
import ops.model_cutils as cutils

def run(hps=None,make_stims=False):
    ...
    #cxpar=dict(cutils.CCPAR, srf=_DEFAULT_SM2003_CSIZE)
    ...
    ########################################
    shift_paper_x = sp.array([.6, 1., 2., 3.3, 5., 10.])
    ...
    #defaults._DEFAULT_PARAMETERS['ssn'] =
    #defaults._DEFAULT_PARAMETERS['ssf'] =
